...
<head>
    ...
    <title> UTS - Deia Iqbal Afzani </title>
</head>
...
<body>
    <form method="POST" action="">
        <table align="center" border="1" cellpadding="0" cellspacing="0">
            <tr align="center">
                <td>
                    <h2> <b>Input Data Pasien Covid 19</b></h2>
                </td>
            </tr>
            <tr>
                <td>
    ...
    include "waktu.php";
    if (
        isset($_POST["wilayah"]) and isset($_POST["positif"]) and isset($_POST["dirawat"]) and isset($_POST["sembuh"])
